...
almost no effect on accuracy. Their might be a very slight advantage of
...
3) Most of the verbs were known, but leg verbs were less known to participants
than arm verbs.
...
a quadruple. 
(Or alternatively: completely randomize the order of verbs respecting the 
quadruple sets, as we did in this pilot.)
...
the correlation is pretty nych driven by the few more extreme observations.
