...
4. If the participant replaces a target word with another word, e.g. says "pluck" instead of the target word "pat", annotate this by writing y=pluck instead of the word "pat". Also separate "y=pluck" with commas and do not use any spaces. If the participant says more than one replacement word, e.g. "pluck,clutch" instead of "pluck", separate the different replacement words with "/" like this: y=pluck/cluthc.
