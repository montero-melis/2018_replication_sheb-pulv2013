...
# f <- "data/999_sheb_replication_1810_2020_Mar_13_1537.log"
...
get_taps(logf, "my rout", 1, 3, 32.1435, 162, 210)
get_taps(logf, "my rout", 1, 3, 32.1435, 100, 105)
```


Identify blocks and find rows with taps:

```{r}
(mystr <- get_structure(logf))
...
plot_taps <- function (df, rout) {
  df <- df %>% filter(routine == rout)
