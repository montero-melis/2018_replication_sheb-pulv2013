...
my_ggsave("SP13_replication_model_estim_d60", 6, 4)
plot_interaction(results_brms_d60[[1]], "N = 60")
my_ggsave("SP13_replication_model_interact_d60", 6, 4)
```
...
pre-registered main analysis for $N=60$. We stopped data collection as soon
as we obtained reliable evidence (based on Bayes factor). By then we had
collected 77 participants in total. Here we report the results of the analysis
for all $N=77$ participants.
...
my_ggsave("SP13_replication_model_estim_d77", 6, 4)
plot_interaction(results_brms_d77[[1]], "N = 77")
my_ggsave("SP13_replication_model_interact_d77", 6, 4)
```
