...
# This function uses the functions readRDS() and saveRDS() (rather than save()
# and load(), the classical ones). This is preferable in the present context
# For reference about the advantages, see:
