...
3. Estimates of variability at the subject level are only given indirectly
in the form of Cohen's $d$ values for different comparisons. While measures
of variability went into those calculations, it is not clear how exactly these
values were computed, resulting in at best indirect estimates of subject
variability based on the original study.
